...
import sty from "./PlasmicDateTimeRangePicker.module.css"; // plasmic-import: QxmPjFisbJk6/css
            ...
            <React.Fragment>
              {(() => {
                const child$Props = {
                  ...
                  className: classNames(
                    "__wab_instance",
                    sty.dateTimePicker___3BRhz
                  ),
                  picker: "date",
                  popupScopeClassName:
                    sty["dateTimePicker___3BRhz__datePickerPopup"],
                  showTime: false
                };
              ...
              {(() => {
                const child$Props = {
                  ...
                  className: classNames(
                    "__wab_instance",
                    sty.dateTimePicker__bu8J
                  ),
                  popupScopeClassName:
                    sty["dateTimePicker__bu8J__datePickerPopup"],
                  showTime: false
                };
                return <AntdDatePicker {...child$Props} />;
              })()}
